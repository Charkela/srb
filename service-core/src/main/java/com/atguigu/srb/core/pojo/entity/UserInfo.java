...
public class UserInfo implements Serializable {
    ...
    public static final String USER_AVATAR="https://srb-file-12-27.oss-cn-hangzhou.aliyuncs.com/111/2023/12/27/5d9c96d9-cd84-4137-a760-fe0e9226cdcc.jpg";
...
//    @JsonFormat(pattern = "yyyy-MM")  //单独设置时间日期格式
